...
pkg_iterator_init(_PkgIteratorObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "sssOO|p:pkg_iterator_init", kwlist,
                                     &primary_path, &filelists_path, &other_path, &py_newpkgcb,
                                     &py_warningcb, &allow_out_of_order)) {
        return -1;
    }
    ...
    // TODO: correct thing to do with error?
    if (tmp_err) {
        nice_exception(&tmp_err, NULL);
        return -1;
    }
    ...
    self->pkg_iterator = cr_PkgIterator_new(
        primary_path, filelists_path, other_path, ptr_c_newpkgcb, &cbdata, ptr_c_warningcb, &cbdata, allow_out_of_order, &tmp_err);
    if (self->pkg_iterator == NULL) {
...
// static PyObject *
// pkg_iterator_repr(_PkgIteratorObject *self)
// {
//     if (check_PkgIteratorStatus(self))
//         return NULL;
//     PyObject *repr;
//     if (self->pkg_iterator) {
//         repr = PyUnicode_FromFormat("<createrepo_c.PkgIterator object>");
//     } else {
//         repr = PyUnicode_FromFormat("<createrepo_c.PkgIterator object id -, ->");
//     }
//     return repr;
// }

// static PyObject *
// pkg_iterator_str(_PackageObject *self)
// {
//     PyObject *ret;
//     if (check_PkgIteratorStatus(self))
//         return NULL;
...
pkg_iterator_is_finished(_PkgIteratorObject *self, G_GNUC_UNUSED void *nothing) {
    ...
    // TODO: other way to construct bool?
...
// TODO: should is_finished() be a method or a property?
// TODO: implement __bool__() as an alias for is_finished()
...
PyTypeObject PkgIterator_Type = {
    ...
    // .tp_getset = pkg_iterator_getsetters,
